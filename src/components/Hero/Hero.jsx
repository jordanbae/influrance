            ...
            <section className={`paddings ${style.wrapper}`}>
                ...
                className={`innerWidth ${style.container}`}>
                    <div className={style.upperElements}>
                        ...
                        className='secondaryText'>Elevate your influence <br/> with protection from Influrance</motion.span>
                    </div>
                    ...
                    variants={slideIn("up", "tween", 0.5,1.3)}
                        src='./hero_person.png' alt="person"/>
                    </motion.div>
                    <div className={style.lowerElements}>
                        ...
                        <motion.div variants={fadeIn("left", "tween", 0.5, 1)} className={style.certificate}>
